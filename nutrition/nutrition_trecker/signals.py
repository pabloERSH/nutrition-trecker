...
def eaten_food_save_base_food_data(sender, instance, **kwargs):    
    ...
    if rows.exists():
        ...
        logger.info(f"Rows in eaten_food updated after BaseFood(id={instance.id}) was deleted")
...
def eaten_food_save_custom_food_data(sender, instance, **kwargs):
    ...
    if rows.exists():
        ...
        logger.info(f"Rows in eaten_food updated after CustomFood(id={instance.id}) was deleted")
...
def eaten_food_save_recipe_data(sender, instance, **kwargs):
    ...
    if rows.exists():
        ...
        logger.info(f"Rows in eaten_food updated after Recipe(id={instance.id}) was deleted")
...
def recipe_ingredient_save_base_food_data(sender, instance, **kwargs):
    ...
    if rows.exists():
        ...
        logger.info(f"Rows in recipe_ingredient updated after BaseFood(id={instance.id}) was deleted")
...
def recipe_ingredient_save_custom_food_data(sender, instance, **kwargs):
    ...
    if rows.exists():
        ...
        logger.info(f"Rows in recipe_ingredient updated after CustomFood(id={instance.id}) was deleted")
