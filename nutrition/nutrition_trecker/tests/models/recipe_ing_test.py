...
class TestRecipeIngredientModel:
    ...
    def test_create_recipe_ingredient_manual_with_invalid_source(self, recipe, custom_food):
        with pytest.raises(IntegrityError), transaction.atomic():
            RecipeIngredient.objects.create(
                recipe=recipe,
                name="Qwerty",
    ...
    def test_create_recipe_ingredient_basefood_with_invalid_source(self, recipe, base_food):
        with pytest.raises(IntegrityError), transaction.atomic():
            RecipeIngredient.objects.create(
                recipe=recipe,
                name="Qwerty",
    ...
    def test_clean_recipe_ingredient_manual_with_invalid_source(self, recipe, base_food):
        with pytest.raises(ValidationError):
            ing = RecipeIngredient(
                recipe=recipe,
                base_food=base_food,
